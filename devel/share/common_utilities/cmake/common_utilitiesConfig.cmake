...
if("TRUE" STREQUAL "TRUE")
  set(common_utilities_SOURCE_PREFIX /home/roboy/workspace/myoarm_small_FPGA/src/common_utilities)
  set(common_utilities_DEVEL_PREFIX /home/roboy/workspace/myoarm_small_FPGA/devel)
  ...
  set(common_utilities_INSTALL_PREFIX /home/roboy/workspace/myoarm_small_FPGA/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'common_utilities' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Simon Trendel <simon.trendel@tum.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'common_utilities' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/roboy/workspace/myoarm_small_FPGA/src/common_utilities/${idir}'.  Ask the maintainer 'Simon Trendel <simon.trendel@tum.de>' to fix it.")
    endif()
